...
; PutChar
; --------------------------------------------------------------------------
; Writes a character to the VDU, converting CR to an LF, CR sequence.
; --------------------------------------------------------------------------
; Inputs:     A: Character to write.
; Destroyed:  F.
; ==========================================================================
PutChar:
	cp '\r'
...
; --------------------------------------------------------------------------
; Writes a byte to the VDU without preserving register state.
; --------------------------------------------------------------------------
; Inputs:     A: Byte to write.
; Destroyed:  AF, BC, DE, HL.
; ==========================================================================
...
; PutString
; --------------------------------------------------------------------------
; Writes a string to the VDU.
; --------------------------------------------------------------------------
; Inputs:     HL: Pointer to the NUL or CR-terminated string to write.
; Outputs:    HL: Points to the next string after the terminator.
;             F: Z set if NUL-terminated, NZ of CR-terminated.
; Destroyed:  HL, AF.
; ==========================================================================
PutString:
	ld a,(hl)
...
; --------------------------------------------------------------------------
; Sends a NUL-terminated string with embedded newlines to the display.
; --------------------------------------------------------------------------
; Inputs:     HL: Pointer to NUL-terminated string.
; Outputs:    HL: Pointer to next string after the terminator.
; Destroyed:  HL, AF.
; ==========================================================================
PutStringWithNewLines:
-:	call PutString
...
; PutHexByte
; --------------------------------------------------------------------------
; Puts a hex byte (00..FF) on the screen.
; --------------------------------------------------------------------------
; Inputs:     A: Hex byte to write.
; Destroyed:  AF.
; ==========================================================================
PutHexByte:
	push af
...
; PutDecimalWord
; --------------------------------------------------------------------------
; Puts a decimal word (0..65535) on the screen.
; --------------------------------------------------------------------------
; Inputs:     HL: Decimal word.
; Destroyed:  None.
; ==========================================================================
PutDecimalWord:
	push af
...
; PutDecimalByte
; --------------------------------------------------------------------------
; Puts a byte (0..255) on the screen.
; --------------------------------------------------------------------------
; Inputs:     A: Decimal value to put on the screen.
; Destroyed:  None.
; ==========================================================================
PutDecimalByte:
	push af
...
; GetCharacterData
; --------------------------------------------------------------------------
; Gets a pointer to the pixel data for a particular character.
; --------------------------------------------------------------------------
; Inputs:     A: The character to get the data for.
...
; BeginBlinkingCursor
; --------------------------------------------------------------------------
; Prepares to draw the blinking cursor.
; --------------------------------------------------------------------------
; Destroyed:  AF.
; ==========================================================================
BeginBlinkingCursor:
...
; EndBlinkingCursor
; --------------------------------------------------------------------------
; Ends drawing the blinking cursor.
; --------------------------------------------------------------------------
; Destroyed:  AF.
; ==========================================================================
EndBlinkingCursor:
